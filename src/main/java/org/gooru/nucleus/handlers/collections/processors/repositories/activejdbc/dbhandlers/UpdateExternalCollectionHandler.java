 ...
 */
class UpdateExternalCollectionHandler implements DBHandler {

  private static final Logger LOGGER = LoggerFactory.getLogger(UpdateExternalCollectionHandler.class);
  private static final ResourceBundle RESOURCE_BUNDLE = ResourceBundle.getBundle("messages");
  private final ProcessorContext context;

  public UpdateExternalCollectionHandler(ProcessorContext context) {
  ...
  public ExecutionResult<MessageResponse> checkSanity() {
    ...
    JsonObject errors = new DefaultPayloadValidator().validatePayload(context.request(),
        AJEntityCollection.editExFieldSelector(), AJEntityCollection.getValidatorRegistry());
  ...
  public ExecutionResult<MessageResponse> executeRequest() {
    ...
    return new ExecutionResult<>(
        MessageResponseFactory.createNoContentResponse(RESOURCE_BUNDLE.getString("updated"),
            EventBuilderFactory.getUpdateExCollectionEventBuilder(context.collectionId())),
