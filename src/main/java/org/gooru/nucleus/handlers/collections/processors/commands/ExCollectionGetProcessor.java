 ...
 */
class ExCollectionGetProcessor extends AbstractCommandProcessor {

  public ExCollectionGetProcessor(ProcessorContext context) {
    super(context);
  }
  ...
  protected MessageResponse processCommand() {
    ...
    return RepoBuilder.buildCollectionRepo(context).fetchExternalCollection();
  }
}
