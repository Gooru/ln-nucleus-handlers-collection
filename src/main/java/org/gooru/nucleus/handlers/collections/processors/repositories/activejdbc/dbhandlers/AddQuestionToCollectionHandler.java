...
class AddQuestionToCollectionHandler implements DBHandler {
    ...
    public ExecutionResult<MessageResponse> checkSanity() {
        ...
        if (context.collectionId() == null || context.collectionId().isEmpty() || context.questionId() == null
    ...
    public ExecutionResult<MessageResponse> executeRequest() {
        ...
        return new ExecutionResult<>(
            MessageResponseFactory.createInternalErrorResponse(resourceBundle.getString("question.add.fail")),
            ExecutionResult.ExecutionStatus.FAILED);
    }
